...
class PIDController:
    ...
    def __init__(self):
        self._centroid_subscriber = rospy.Subscriber('/line_follower/centroid_point', Point32, callback=self.callback, queue_size=1)
        # self._centroid_subscriber = rospy.Subscriber('/line_follower/image_resolution', Point32, callback=self.image_resolution_callback, queue_size=1)
