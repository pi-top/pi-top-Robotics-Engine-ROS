...
class ServoMoveController:
    ...
    def servo_move(self, pan_rad_s, tilt_rad_s):
        ...
        self._pan_servo.set_target_speed = pan_deg_s
        self._tilt_servo.set_target_speed = tilt_deg_s
...
if __name__ == "__main__":
    ...
    tilt_servo = PMAServoMotor(tilt_servo_port)
    pan_servo = PMAServoMotor(pan_servo_port)
    # set zero points
    # pan_servo.zero_point = 4
    # tilt_servo.zero_point = -18
    pan_servo.set_target_angle(0)
    tilt_servo.set_target_angle(0)
